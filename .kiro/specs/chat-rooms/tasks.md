...
- [-] 1. 프로젝트 구조 설정 및 핵심 타입 정의
  ...
  - [x] 1.2 공유 TypeScript 타입 및 인터페이스 정의
...
- [x] 2. 데이터베이스 계층 구현
  - [x] 2.1 SQLite 데이터베이스 초기화 및 스키마 생성
...
- [x] 5. REST API 라우터 구현
  ...
  - [x] 5.2 REST API 단위 테스트 작성
    - 대화방 생성 성공/실패 케이스 테스트
    - 대화방 목록 조회 및 빈 목록 케이스 테스트
    - 존재하지 않는 대화방 접근 시 404 응답 테스트
    - _Requirements: 1.4, 2.4_

- [x] 6. Socket.IO 이벤트 핸들러 구현
  - [x] 6.1 Socket.IO 서버 설정 및 이벤트 핸들러 구현
...
- [x] 9. 프론트엔드 구현 - 대화방 목록 페이지
  - [x] 9.1 React 프로젝트 설정 및 라우팅 구성
  ...
  - [x] 9.2 RoomListPage 및 하위 컴포넌트 구현
...
- [x] 10. 프론트엔드 구현 - 대화방 화면
  - [x] 10.1 ChatRoomPage 및 하위 컴포넌트 구현
